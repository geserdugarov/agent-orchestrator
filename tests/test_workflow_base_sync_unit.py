...
class CleanRebaseRoutingUnitTest(_SyncWorktreeWithBaseFixture, unittest.TestCase):
    ...
    def test_conflict_rebase_routes_to_resolution(
        self,
    ) -> None:
...
class CrashRecoveryAnchorUnitTest(_SyncWorktreeWithBaseFixture, unittest.TestCase):
    ...
    def test_unreadable_pre_head_parks_without_rebase(
        self,
    ) -> None:
    ...
    def test_crashed_rebase_dirty_reaches_recovery(
        self,
    ) -> None:
    ...
    def test_stale_anchor_cleared_after_label_exit(
        self,
    ) -> None:
