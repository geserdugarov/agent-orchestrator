...
# Canonical inventory of the read-model surface this facade re-exports.
# Every entry is imported above from a focused sibling module (`connection`,
# `read_raw`, `read_rollup`, `read_dashboard`, `read_models`); keeping the
# list explicit makes the compatibility surface auditable in one place and
# governs `from orchestrator.analytics.read import *`. The private
# connection-plumbing names (`_default_connect`, `_thread_local`, ...) stay in
# the list because tests reach them through this module.
__all__ = [
    "AgentExitRow",
    "AnalyticsReadError",
    ...
    "_close_quietly",
    "_default_connect",
    "_default_persistent_connect",
    "_is_broken_connection_exc",
    "_thread_local",
