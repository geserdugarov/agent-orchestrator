---
name: develop
description: Project conventions and recurring gotchas for implementer agents working on agent-orchestrator. Use before opening a PR for any change in orchestrator/, tests/, docs/, or plans/.
---
